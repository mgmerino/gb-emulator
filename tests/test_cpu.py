"""The machine: the register file, the fetch, the stack, and the step loop.

Instruction behaviour lives in test_instructions.py. What is here fails when
`step()`, `fetch_u8` or `push16` is wrong, not when an instruction body is.
"""
